...
void Serializer::_serialize(const T& obj)
{
    ...
    //    static_assert(std::is_trivially_copyable<T>::value, "Missing Serializer::_serialize overload for T = "/*
    //    __PRETTY_FUNCTION__*/);
...
void Serializer::deserialize(T& obj)
{
    // This should really be used to avoid simply copying complex objects that are not trivially copyable
    // std::is_trivially_copyable is shipped with GCC 5
    //    static_assert(std::is_trivially_copyable<T>::value, "Missing Serializer::deserialize overload for T = "/*
    //    __PRETTY_FUNCTION__*/);
...
size_t Serializer::get_size(const T& obj)
{
    // This should really be used to avoid simply copying complex objects that are not trivially copyable
    // std::is_trivially_copyable is shipped with GCC 5
    //    static_assert(std::is_trivially_copyable<T>::value, "Missing Serializer::get_size overload for T = "/*
    //    __PRETTY_FUNCTION__*/);
